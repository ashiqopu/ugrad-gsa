<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plateMonthly1.aspx.cs" Inherits="shamim_plateMonthly1" %>
...
<head id="Head1" runat="server">
  <title>Plate-Monthly Report</title>
  ...
  <div id="main">		
    ...
    <header>
	  ...
	  <div id="content">
        ...
        <h1>
        &nbsp;&nbsp;&nbsp;Plate No. :&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="plateno" runat="server" Height="29px" Width="141px"></asp:TextBox>           
        &nbsp;&nbsp;&nbsp;Select Month:&nbsp;&nbsp;&nbsp;
