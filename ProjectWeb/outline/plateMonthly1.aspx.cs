...
public partial class shamim_plateMonthly1 : System.Web.UI.Page
{
    ...
    {
        if (plateno.Text != "" && DropDownList1.Text != "Select.." && DropDownList2.Text != "Select..")
        {
            ...
            Session["mpno"] = plateno.Text.ToString();
            Session["fdate"] = TextBox1.Text.ToString();
            Session["ldate"] = TextBox2.Text.ToString();

            Response.Redirect("platemonthly.aspx");
        }
    }
