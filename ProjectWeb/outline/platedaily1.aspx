<%@ Page Language="C#" AutoEventWireup="true" CodeFile="platedaily1.aspx.cs" Inherits="shamim_platedaily1" %>
...
<head id="Head1" runat="server">
  <title>Plate-Daily Report</title>
  ...
  <div id="main">		
    ...
    <header>
	  ...
	  <div id="content">
        ...
        <h1>
            &nbsp;&nbsp;&nbsp;Plate No. :&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox2" runat="server" Height="29px" Width="141px"></asp:TextBox>
             &nbsp;&nbsp;&nbsp;Select Date :&nbsp;&nbsp;&nbsp;
